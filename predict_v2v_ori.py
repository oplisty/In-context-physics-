...
# validation_video = "/ssd1/jinxiu/PhysVideoGen/Cogvideo1.5/CogVideoX-Fun/rigging/6_1737601842.mp4"
validation_video_mask   = None 
denoise_strength        = 0.5

# prompts

prompt_structure = "The two-panel video with [LEFT] showing a reference physical phenomenon and [RIGHT] demonstrating the same physical phenomenon in "
prompt = prompt_structure + " a basketball is falling "
# prompt = "A panda is dancing in the white background"
# prompt = "A basketball is falling" 0000024
